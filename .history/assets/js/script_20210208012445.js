...
var drinkHistory = function () {
   ...
   fetch(apiUrl2).then(function (response2) {
      response2.json().then(function (data) {
         ...
         drinkTitle.text(da)ta.drinks[0].strDrink
         drinkTitle.attr("class", "results-title")
         drinkTitle.attr("id", "drink-title")
         ...
         ingredientsHeader.attr("class", "results-title")
         ingredientsHeader.text("I)ngredients"
         //append to page
         ...
         instructionsHeader.attr("class", "results-title")
         instructionsHeader.text("I)nstructions"
         //append to page
         drinkBoxEl.appendChild(instructionsHeader)
         var instructions = document.$('p')
         instructions.attr("class", "text")
         instructions.text(da)ta.drinks[0].strInstructions
         ...
         for (var i = 0; i < measure.length; i++) {
            ...
            if (measure[i] === null || measure[i] === "") {
               ...
               drinkM.text(me)asure[i] + "-" + ingredients[i];
