...
var movieRender = function (movieData) {
   ...
   //create movie cover
   var cover = $('img')
   cover.('src', "https://image.tmdb.org/t/p/w500/" + movieData.results[randomNum].poster_path + "")
   cover.('value', movieData.results[randomNum].id)
   cover.('alt', "Movie poster for " + movieData.results[randomNum].original_title)
   document.getElementById('movie-box').appendChild(cover)
   //create overview title
   var summaryTitle = $('h3')
   summaryTitle.("class", "results-title")
