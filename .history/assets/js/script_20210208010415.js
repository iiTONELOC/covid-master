...
var savePlan = function () {
   ...
   if (!duplicate) {
      ...
      var aE1 = $('<a>')
      aE1.attr('href', "")
      aE1.text("Enjoying a " + document.getElementById("meal-title").textContent + ", with a " + document.getElementById("drink-title").textContent + ", while watching " + document.getElementById('movie-title').textContent)
      //creates the span inside the link
      var span = $('<span>')
      span.attr('class', 'float-right')
      //create the icon inside the span
      ...
      drinkName = $("3drink-title").textContent
