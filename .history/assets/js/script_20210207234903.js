...
drinkImg..("alt", "Picture of a " + data.drinks[0].strDrink)
...
ingredientsHeader..("class", "results-title")
ingredientsHeader.textContent = "Ingredients"
//append to page
...
instructionsHeader..("class", "results-title")
instructionsHeader.textContent = "Instructions"
//append to page
drinkBoxEl.appendChild(instructionsHeader)

var instructions = $('p')
instructions..("class", "text")
