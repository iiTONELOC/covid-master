...
var renderMeal = function(data,  data2) {
   ...
   if (data2.meals[0].strSource) {
      var recipe = $("<a>")
      recipe.att("href", data2.meals[0].strSource);
      recipe.att("target", "_blank")
   ...
   ingredientsHeader.att("class", "results-title")
   ...
   instructionsHeader.att("class", "results-title")
   instructionsHeader.textContent = "Instructions"
   //append to page
   mealBoxE1.appendChild(instructionsHeader)
   var instructions = document.createElement('p')
   instructions.att('class', "text");
      ...
      response.json().then(function (data) {
         ...
         fetch(apiUrl2).then(function (response2) {
            ...
            renderMeal(data, data2)
               ...
               //video.att("src", data2.meals[0].strYoutube);
