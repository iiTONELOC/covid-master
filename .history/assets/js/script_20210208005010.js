...
// VAR FUNCTION FOR API MEAL(KH)(!current set up just to run a random meal!)
var meal = function () {
   if (mealType === "random") {
...
// VAR FUNCTION FOR API DRINKS(KH)( var function api call drink !current set up just to run a random meal!
var drink = function () {
   if (drinkType === "random") {
