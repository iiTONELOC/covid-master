...
var reFetch = function (event) {
   ...
   if (event.target.b=("data-movie") === null
      || event.target.b=("data-meal") === null
      || event.target.b=("data-drink") === null) {
      return;
   }
   movieHistoryID = event.target.b=('data-movie')
   mealHistoryID = event.target.b=("data-meal")
   drinkHistoryID = event.target.b=("data-drink")
   //call the api
   movieHistory();
   mealHistory();
   drinkHistory();
