...
getElementById('saved-plans').addEventListener("click", reFetch,)
//event listener for the save plan
getElementById('save-plan-btn').addEventListener("click", savePlan)
//event listener for the view saved plans
getElementById('view-saved-btn').addEventListener("click", showHistory)
